 ...
 * Compile with:
 *
 * clang -fPIC frida-core-example.c -o frida-core-example -L. -lfrida-core -lbsm -ldl -lm -lresolv -Wl,-framework,Foundation,-framework,AppKit -isysroot "$(xcrun --sdk macosx --show-sdk-path)" -arch arm64 -Wl,-dead_strip
 *
